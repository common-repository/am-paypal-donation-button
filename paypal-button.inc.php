...
$am_paypal_opts =  get_option('am_paypal_donation_button');
		...
		if ( ! empty( $am_paypal_opts['am_paypalReturnPageCancel'] ) ) {
			$am_paypalReturnPageCancel = esc_html( $am_paypal_opts['am_paypalReturnPageCancel'] );			
		}	
		
		if ( ! empty( $am_paypal_opts['am_paypalReturnMethod'] ) ) {
			$am_paypalReturnMethod = esc_html( $am_paypal_opts['am_paypalReturnMethod'] );			
		}		
